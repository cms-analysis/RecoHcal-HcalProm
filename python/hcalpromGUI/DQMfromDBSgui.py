...
class dbsAccessor:
    ...
    def searchDBS(self,beginrun=-1, endrun=-1,mytext=None):
        ...
        if (mytext==None):
            ...
            mytext="find run where dataset=%s and run between %i-%i"%(self.searchString.get(),self.beginRun.get(),self.endRun.get())
        #print "mytext = ",mytext
...
class DQMDBSgui:
    ...
    def __init__(self, parent=None, debug=False):
        ...
        self.basedir=os.path.join(self.basedir,"src/RecoHcal/HcalProm/python/hcalpromGUI")
        ...
        self.commentLabel=Label(self.statusFrame,
                                ...
                                fg=self.bg_alt,
                                height=2,
                                text="Welcome to the Hcal Prompt DQM/DBS GUI")
        statusrow=0
    ...
    def printDBS(self):
        ...
        myvars={"  DBS Dataset Search String = ":self.myDBS.searchString,
